...
import { PlusIcon, Search, Users, User, UserPlus } from "lucide-react"
...
export function ChatSidebar({ onToggleFriends }: ChatSidebarProps) {
  ...
  return (
    <div className="w-72 border-r border-zinc-800 flex flex-col h-full">
      <div className="p-4 border-b border-zinc-800">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-1">
            ...
            <Button variant="ghost" size="icon" onClick={onToggleFriends} aria-label="Toggle Friends List">
